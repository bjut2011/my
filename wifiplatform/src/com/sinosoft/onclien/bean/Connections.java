...
public class Connections {
	...
	public Integer getAuth_plattype() {
		return auth_plattype;
	}
	public void setAuth_plattype(Integer auth_plattype) {
		this.auth_plattype = auth_plattype;
	}
