...
public class CountQuartzDaoImpl implements CountQuartzDao {
	...
	public Integer queryApStatus(Map map) {
		try {
			return (Integer) sqlMapClient.queryForObject("queryApStatus",map);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return null;
	...
	public Integer queryCustomerStatus(Map map) {
		try {
			return (Integer) sqlMapClient.queryForObject("queryCustomerStatus",map);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return null;
	 ...
	 * @return
	 */
	public HashMap queryConnectionsbyday(String mac) {
		try {
			return (HashMap) sqlMapClient.queryForObject("queryConnectionsbyday",mac);
		} catch (SQLException e) {
			e.printStackTrace();
		}
		return null;
	...
	public void clearCount() {
		try {
			sqlMapClient.update("clearCount");
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
