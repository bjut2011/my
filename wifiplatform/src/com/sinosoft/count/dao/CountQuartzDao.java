...
public interface CountQuartzDao {
	 ...
	 * @return
	 */
	Integer queryApOnline(Map map);

	Integer queryApStatus(Map map);
	
	Integer queryCustomerStatus(Map map);
	 ...
	 * @return
	 */
	HashMap queryConnectionsbyday(String mac);
