...
public class RemoteCallUtil {
	...
	public static String remoteCall(Map<String,Object> javabean) {
		...
		if ("portal_set".equals(type)) {
			...
			obj.element("times", "3");
			obj.element("available", "5");
		}else if("ssid".equals(type)){
			path = "http://"+javabean.get("ip")+"/update_ssid.json";
			obj.element("mac", javabean.get("mac"));
			obj.element("params", javabean.get("ssid"));
			obj.element("time_delay", javabean.get("authinterval"));
			obj.element("times", "3");
			obj.element("available", "5");
			...
			path = "http://"+javabean.get("ip")+"/update_ssid.json";
			obj.element("mac", javabean.get("mac"));
			obj.element("params", "hostname:"+javabean.get("hostname"));
			obj.element("time_delay", javabean.get("authinterval"));
			obj.element("times", "3");
			obj.element("available", "5");
		}
			...
			obj.element("times", "3");
			obj.element("available", "5");
			Integer cmd=(Integer)javabean.get("cmd_flag");
			if (cmd==5){
				obj.element("url", javabean.get("url"));
			}
		}
