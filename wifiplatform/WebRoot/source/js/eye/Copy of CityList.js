...
(function() {
					...
					h
							.attachEvent(
									...
									function(l) {
										...
										if (k
												&& (k.readyState == "loaded" || k.readyState == "complete")) {
											k.parentNode.removeChild(k)
										}
									})
				}
	...
	d.prototype._initContainer = function() {
		...
		var g = b.g(this._opts.container), p = document.createElement("select"), r = document
				.createElement("select"), i = document.createElement("select"), m = document
