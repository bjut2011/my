...
ap_setTab = function (i){
	switch (i) {
	  case '1': 
		  	  $("#ap_xieyi").show();$("#ap_whitelist").hide();$("#ap_portal").hide();$("#ap_ycsj").hide();$("#ap_yckz").hide(); $("#ap_whitelist_mac").hide();$("#ap_rzsz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	    break;
	  case '2': $("#ap_portal").show();$("#ap_xieyi").hide();$("#ap_whitelist").hide();$("#ap_ycsj").hide();$("#ap_yckz").hide(); $("#ap_whitelist_mac").hide();$("#ap_rzsz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	    break;
	  case '3': $("#ap_whitelist").show();$("#ap_xieyi").hide();$("#ap_portal").hide();$("#ap_ycsj").hide();$("#ap_yckz").hide(); $("#ap_whitelist_mac").hide();$("#ap_rzsz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	    break;
	  case '4': $("#ap_ycsj").show(); $("#ap_xieyi").hide();$("#ap_portal").hide();$("#ap_whitelist").hide();$("#ap_yckz").hide(); $("#ap_whitelist_mac").hide();$("#ap_rzsz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	  break;
	  case '5': $("#ap_yckz").show(); $("#ap_xieyi").hide();$("#ap_portal").hide();$("#ap_ycsj").hide();$("#ap_whitelist").hide(); $("#ap_whitelist_mac").hide();$("#ap_rzsz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	  break;
	  case '6': $("#ap_whitelist_mac").show(); $("#ap_xieyi").hide();$("#ap_whitelist").hide();$("#ap_portal").hide();$("#ap_ycsj").hide(); $("#ap_yckz").hide();$("#ap_rzsz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	  break;
	  case '7': $("#ap_rzsz").show();$("#ap_whitelist_mac").hide(); $("#ap_xieyi").hide();$("#ap_whitelist").hide();$("#ap_portal").hide();$("#ap_ycsj").hide(); $("#ap_yckz").hide();$("#ap_authinterval").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	  break;
	  case '8': $("#ap_authinterval").show();$("#ap_whitelist_mac").hide(); $("#ap_xieyi").hide();$("#ap_whitelist").hide();$("#ap_portal").hide();$("#ap_ycsj").hide(); $("#ap_yckz").hide();$("#ap_rzsz").hide();$("#ap_ssid").hide();$("#ap_hostname").hide();
	  break;
	  case '9': $("#ap_authinterval").hide();$("#ap_whitelist_mac").hide(); $("#ap_xieyi").hide();$("#ap_whitelist").hide();$("#ap_portal").hide();$("#ap_ycsj").hide(); $("#ap_yckz").hide();$("#ap_rzsz").hide();$("#ap_ssid").show();$("#ap_hostname").hide();
	  break;
	  case '10': $("#ap_authinterval").hide();$("#ap_whitelist_mac").hide(); $("#ap_xieyi").hide();$("#ap_whitelist").hide();$("#ap_portal").hide();$("#ap_ycsj").hide(); $("#ap_yckz").hide();$("#ap_rzsz").hide();$("#ap_ssid").hide();$("#ap_hostname").show();
	  break;
	}
	...
	//协议保存
		...
		//远程升级保存
		 $("#save_ssid").click(function(){
			 $("#set_ssid_form input").each(function(i){
				  if(this.value==""){
					  return false;
				  }else{ 
					  $.ajax({
					   		type: "POST",
					   	 	dataType:"json",   
						   url:"apmController!saveSSID", 
						   data:$('#set_ssid_form').serialize()+"&$id="+id+"&$mac="+mac+"&timestamp=" + new Date().getTime(),
						   success: function(data){
						 alert(data[0].code);
						 $("#ap_TabDiv").window('close');
							}
		...
		//远程升级保存
		 $("#save_hostname").click(function(){
			 $("#set_hostname_form input").each(function(i){
				  if(this.value==""){
					  return false;
				  }else{ 
					  $.ajax({
					   		type: "POST",
					   	 	dataType:"json",   
						   url:"apmController!saveHostname", 
						   data:$('#set_hostname_form').serialize()+"&$id="+id+"&$mac="+mac+"&timestamp=" + new Date().getTime(),
						   success: function(data){
						 alert(data[0].code);
						 $("#ap_TabDiv").window('close');
							}
