	...
	<div class="AP_wrap">
		<div class="AP_title">
			<ul>
				...
				<li><a href="${ctx}/app!initRouterManage.do">Router</a>
				</li>
			</ul>
		</div>
		<div class="AP_used">
		...
		<div style="height:450px;width: 100%;overflow-y:auto;"id="up_div">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="data_table" class="AP_table">
				<tr style="background:#d4e1ee;">
					<td width="8%"><div align="center">名称</div>
					</td>
					...
					<td width="8%"><div align="center">热点</div>
					</td>
					<td width="12%"><div align="center">类别</div>
					</td>
					<td width="12%"><div align="center">安装命令</div>
					</td>
					<td width="12%"><div align="center">卸载命令</div>
					</td>
					<td width="12%"><div align="center">opkg</div>
					</td>
					<td width="12%"><div align="center">renew命令</div>
					</td>
					
				</tr>
				<c:forEach items="${plugin}" var="apm" >
	                ...
	                <td width="8%"><div align="center">${apm.imagename}</div></td>
	                <td width="8%"><div align="center">${apm.ishot}</div></td>
	                <td width="10%"><div align="center">${apm.category}</div></td>
	                <td width="10%"><div align="center">${apm.installcmd}</div></td>
	                <td width="10%"><div align="center">${apm.removecmd}</div></td>
	                <td width="10%"><div align="center">${apm.opkg}</div></td>
	                <td width="10%"><div align="center">${apm.renewcmd}</div></td>
	              </tr>
