				...
				<div class="wrap">
					<div class="top">
						<p style="border-bottom: 1px solid #95B8E7;">
							<span style="margin-left:5px;">计划名称</span><input type="text"
								id="plan_name" style="margin-left:5px;" /> <span >更新包地址</span><input type="text"
								id="plan_url" style="margin-left:5px;" /><span
								style="margin-left:5px;">计划执行时间</span> <input name="set_time"
								id="plan_time" style="margin-left:5px;" type="text"
