		...
		<div class="filter-bg">
			<div class="filter-wrap" alog-alias="bainuo-channel-filter-wrap"
				...
				<div class="w-filter filter-channel">
					...
					<div class="w-district filter-section" mon="area=filterArea"
						...
						<div id="j-district-filter-list"
							...
							<div id="j-district-item-wrap" class="filter-item-wrap">
								<a href="http://bj.nuomi.com/all"
									...
									href="javascript:borough('朝阳区')" class="w-filter-item  "
						...
						<div class="sub-filter-section">
							<div class="sub-filter-list" id="j-sub-filter-list">
								<a href="http://bj.nuomi.com/all/396"
									...
									href="javascript:business('西直门')" class="w-filter-item  "
				...
				<script type="text/javascript">
					...
					var borough_id="";
					var business_id="";
					cityList.selectProvince("北京市","北京市");
					...
					function  borough(name,value){
						...
						if(borough_id!=""){
							removeClass(document.getElementById(borough_id),"filter-active-all");
						}
						borough_id="id_"+value;
						addClass(document.getElementById("id_"+value),"filter-active-all");
					...
					function  business(name,value){
						...
						if(business_id!=""){
							removeClass(document.getElementById(business_id),"filter-active-all");
						}
