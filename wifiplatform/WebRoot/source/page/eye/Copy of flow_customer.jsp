...
<!DOCTYPE html>
<!-- saved from url=(0043)http://huiyan.baidu.com/malldemo/flow/going -->
<html class="expanded">
<head>
...
<body>
	<div class="header">
		<div class="h-logo">
			<a href="http://huiyan.baidu.com/" title="爱WIFI慧眼">
			</a>
		</div>
		<div class="h-nav">
	...
	<div class="layout_content">
		<div class="layout_leftnav" style="min-height: 1551px;">
								...
								<div unselectable="on"
									...
									<span _cid="1" style="display: inline;"><span
										style="font-size: 11px">© 2015 Baidu&nbsp;- Data © <a
											...
											href="http://www.cennavi.com.cn/" style="display: inline;">CenNavi</a>
											&amp; <a target="_blank" href="http://www.365ditu.com/"
	...
	<script type="text/javascript" src="${ctx}/source/js/eye/heatmap.js"></script>
	...
	<div id="calendar_1419491852850" class="ta_calendar ta_calendar2 cf"
		style="z-index: 9999; display: none;">
		<div class="ta_calendar_cont cf" id="dateRangePicker_1419491852850">
				...
				<tbody>
					<tr>
						<td colspan="7" style="text-align: center;"><a
							href="javascript:void(0);" id="dateRangePreMonth_1419491852850"><i
								class="i_pre"></i></a></td>
					</tr>
					<tr>
			...
			<table class="dateRangeDateTable">
				...
				<tbody>
					<tr>
						<td colspan="7" style="text-align: center;"><a
							href="javascript:void(0);" id="dateRangeNextMonth_1419491852850"><i
								class="i_next"></i></a></td>
					</tr>
					<tr>
						<td class="ta_dateRangeGray">27</td>
		...
		<div class="ta_calendar_footer cf">
			<div class="frm_msg">
				<div id="dateRangeDiv_1419491852850">
					<input type="text" class="ta_ipt_text_s ta_dateRangeSelected"
						name="startDate_1419491852850" id="startDate_1419491852850"
						value="2014-08-25" readonly="" style="background-repeat: repeat;"><span
						class="joinLine"> - </span><input type="text"
						class="ta_ipt_text_s" name="endDate_1419491852850"
						id="endDate_1419491852850" value="2014-08-31" readonly=""><br>
				</div>
				<div id="dateRangeCompareDiv_1419491852850" style="display: none;">
					<input type="text" class="ta_ipt_text_s"
						name="startCompareDate_1419491852850"
						id="startCompareDate_1419491852850" value="" readonly=""
						disabled="disabled"><span class="joinLine"> - </span><input
						type="text" class="ta_ipt_text_s"
						name="endCompareDate_1419491852850"
						id="endCompareDate_1419491852850" value="" readonly=""
						disabled="disabled">
				</div>
			</div>
			<div class="frm_btn">
				<input class="ta_btn ta_btn_primary" type="button"
					name="submit_1419491852850" id="submit_1419491852850" value="确定"><input
					class="ta_btn" type="button" id="closeBtn_1419491852850" value="取消">
			</div>
		</div>
	</div>
</body>
