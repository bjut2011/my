...
<body>
	...
	<div class="layout_content">
			...
			<div class="page-sidebar-wrapper">
				<div class="page-sidebar navbar-collapse collapse">
					<ul class="page-sidebar-menu" data-auto-scroll="true"
						...
						<li class="start active"><a href="mall!init.do"> <i
						...
						<li class="start"><a href="javascript:void(0)"> <i
							...
							<ul class="sub-menu" style="display: none;">
								<li><a href="mall!flow_actual.do"> ·&nbsp;实时客流</a></li>
								<li><a href="mall!flow_all.do"> ·&nbsp;整体客流</a></li>
								<li><a href="mall!flow_storey.do"> ·&nbsp;楼层客流</a></li>
							</ul></li>
						<li class="start "><a href="javascript:void(0)"> <i
							...
							<ul class="sub-menu" style="display: none;">
								<li><a href="mall!customer_portrait.do"> ·&nbsp;顾客画像</a></li>
								<li><a href="mall!flow_coming.do"> ·&nbsp;顾客来源</a></li>
								<li><a href="mall!flow_going.do"> ·&nbsp;顾客去向</a></li>
								<li><a href="mall!flow_customer.do"> ·&nbsp;顾客忠诚度</a></li>
							</ul></li>
						<li class="start "><a href="javascript:void(0)"> <i
							...
							<ul class="sub-menu" style="display: none;">
								<li><a href="mall!compare_portrait.do"> ·&nbsp;客流画像</a></li>
								<li><a href="mall!compare_customer.do"> ·&nbsp;客流指数</a></li>
							</ul></li>
						<li class="start "><a href="javascript:void(0)"> <i
							...
							<ul class="sub-menu" style="display: none;">
								<li><a href="mall!near_customer.do"> ·&nbsp;周边居民</a></li>
								<li><a href="mall!near_poi.do"> ·&nbsp;行业POI数据</a></li>
							</ul></li>
					</ul>
				</div>
			</div>
		...
		<div class="layout_rightmain" style="padding-top: 0px;">
				...
				<div class="tool_date cf" style="display: none;">
					<div class="date" id="div_date">
						...
						<a class="opt_sel" id="input_trigger"
							href="http://huiyan.baidu.com/malldemo/flow/portrait#"> <i
							class="i_orderd"></i>
						</a>
					</div>
					<label class="contrast" for="needCompare_1419478438901"
						style="display: none;"><input type="checkbox" class="pc"
						name="needCompare_1419478438901" id="needCompare_1419478438901"
			...
			<div class="chartArea">
				<div class="coming">
					<dl class="itemBox">
						...
						<dd class="clearfix">
							...
							<div id="hobby_main" _echarts_instance_="1419478438573"
								...
								<div
									...
									<div
										style="position: absolute; display: block; border: 0px solid rgb(51, 51, 51); white-space: nowrap; transition: left 0.4s, top 0.4s; -webkit-transition: left 0.4s, top 0.4s; border-radius: 4px; color: rgb(255, 255, 255); text-decoration: none; font-family: Arial, Verdana, sans-serif; font-size: 12px; line-height: 18px; font-style: normal; font-weight: normal; padding: 5px; left: 587px; top: 312px; background-color: rgba(0, 0, 0, 0.701961);">
										星座运势<br>用户兴趣 : 203.95
									</div>
								</div>
							</div>
							...
							<div id="hobby_second" _echarts_instance_="1419478438574"
								style="cursor: default; background-color: rgba(0, 0, 0, 0);">
								<div
									style="position: relative; overflow: hidden; width: 1057px; height: 400px;">
									<div width="1057" height="400" data-zr-dom-id="bg"
				...
				<div class="coming">
					<dl class="itemBox">
						...
						<dd class="clearfix">
							<div class="hobby_nodate"
								style="text-align: center; height: 2em; line-height: 2em; display: none; background: rgb(255, 254, 209);">加载中...</div>
							<div id="hobby_property" _echarts_instance_="1419478438571"
								style="cursor: default; background-color: rgba(0, 0, 0, 0);">
								<div
									style="position: relative; overflow: hidden; width: 1057px; height: 400px;">
									<div width="1057" height="400" data-zr-dom-id="bg"
									...
									<canvas width="1057" height="400" data-zr-dom-id="2"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 400px;"></canvas>
									<canvas width="1057" height="400" data-zr-dom-id="3"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 400px;"></canvas>
									<canvas width="1057" height="400" data-zr-dom-id="4"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 400px;"></canvas>
									<canvas width="1057" height="400" data-zr-dom-id="6"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 400px;"></canvas>
									<canvas width="1057" height="400" data-zr-dom-id="8"
				...
				<div class="customer_newold">
					<dl class="itemBox">
						<dt>新老客流比</dt>
						<dd>
							<div id="echart_customer_newold"
								_echarts_instance_="1419478438572"
								style="cursor: default; background-color: rgba(0, 0, 0, 0);">
								<div
									style="position: relative; overflow: hidden; width: 1057px; height: 300px;">
									<div width="1057" height="300" data-zr-dom-id="bg"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></div>
									<canvas width="1057" height="300" data-zr-dom-id="1"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
									<canvas width="1057" height="300" data-zr-dom-id="2"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
									<canvas width="1057" height="300" data-zr-dom-id="3"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
									<canvas width="1057" height="300" data-zr-dom-id="4"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
									<canvas width="1057" height="300" data-zr-dom-id="6"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
									<canvas width="1057" height="300" data-zr-dom-id="8"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
									<canvas width="1057" height="300"
										data-zr-dom-id="_zrender_hover_"
										style="position: absolute; left: 0px; top: 0px; width: 1057px; height: 300px;"></canvas>
								</div>
							</div>
	...
	<script type="text/javascript">
		...
		!function() {
			require('home:widget/customer/property.js').init();
		}();
		!function() {
			require('home:widget/customer_newold/customer_newold.js').init();
		}();
		!function() {
