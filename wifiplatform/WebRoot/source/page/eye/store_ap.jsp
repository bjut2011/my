			...
			<div class="uc-side fl">
				<ul class="w-nav clearfix" id="j-uc-nav" mon="element_type=nav"
					...
					<li class="nav-active  nav-current"><a class="nav-txt j-nav"
						...
						<ul class="sub-nav" mon="area=subNav">
							<li><a href="#" class="sub-nav-active"> <span
					...
					<table class="order-list" mon="area=orderList">
						<tbody>
							...
							<c:forEach items="${apMessageList}" var="apm">
								<tr>
									<td class="goods-info"><span class="font14">在线</span>
									</td>
									<td class="font14">${apm.name}</td>
									<td><span class="font14">${apm.mac}</span></td>
									<td><span class="font14">${apm.ssid}</span></td>
									<td class="blank-10">${apm.uptime}</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
