                ...
                if (code == '') {
                    $.ajax({
                        ...
                        success: function(json){
                            ...
                            html += "<tr style='height: 35px; line-height: 44px; background: #61E4B5;font-size:16px;font-family:微软雅黑;'><td align='center'>区域</td><td align='center'>AP总数</td><td align='center'>离线数</td><td align='center'>在线数</td><td align='center'>在线比例</td><td align='center'>上行流量(MB)</td><td align='center'>下行流量(MB)</td><td align='center'>客户数</td></tr>";
                            for (var i = 0; i < json.length; i++) {
        ...
        <div class="wrap" >
            ...
            <div style="height:220px;overflow:auto" id="countTable">
                <table width="96%" border="1" style="margin: 0 auto; border: #74c1c4;">
                    <tr style="height: 35px; line-height: 44px; background: #61E4B5;font-size:16px;font-family:微软雅黑;">
                        <td align="center">
                            区域
                        </td>
                        <td align="center">
