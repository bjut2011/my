...
<link href="${ctx}/source/css/wifiui/bootstrap.min.css" rel="stylesheet" media="screen">
	...
	var code= treeNode.id;
		$.ajax({
					...
					success : function(json) {
						...
						pcode= code;
						var htmlStr = "";
						htmlStr += " <table width='100%' border='0' cellspacing='0' cellpadding='0' class='AP_table ctl'  id='data_table'>";
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<form id="usersearch" class="navbar-form navbar-left" role="search">
						<div class="form-group">
							<input type="text" id="searchbymac" class="form-control" placeholder="请输入MAC地址进行搜索">
						</div>
						
						<div class="form-group" style="margin-left: 28px">
							<div class="radio-list">
								<label class="radio-inline"> <input type="radio" name="optionsRadios" id="Radio1" value="ONLINE" checked=""> 在线用户
								</label> <label class="radio-inline"> <input type="radio" name="optionsRadios" id="Radio2" value=""> 所有用户
								</label>
							</div>
						</div>
						<button id="btn_search_user" type="button" class="btn btn-info" onclick="querybymac(pcode);"> 查询</button>
					</form>
				</div>
			</nav>
		</div>
		...
		<div style="height:450px;width: 100%;overflow-y:auto;" id="up_div">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="data_table" class="AP_table ctl">
				...
				<tr>
					...
					<td width='15%'><div align='center'>${c.pname }</div></td>
				</tr>
				</c:forEach>
			</table>
		</div>
