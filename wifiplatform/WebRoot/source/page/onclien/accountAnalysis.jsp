            ...
            function queryApCusCount(){
                ...
                $.ajax({
                    ...
                    success: function(json){
                        ...
                        html += "<tr style='height: 35px; line-height: 44px; background: #61E4B5;font-size:16px;font-family:微软雅黑;'><td align='center'>MAC</td><td align='center'>商户名称</td><td align='center'>在线客户数量</td><td align='center'>所在区域</td><td align='center'>详细地址</td><td align='center'>日期</td></tr>";
                        for (var i = 0; i < json.length; i++) {
